...
function getMusicInfo(search) {
	...
	var settings = {
		"async": true,
		"crossDomain": true,
		"url": "https://api.musixmatch.com/ws/1.1/track.search?apikey=2d5aab3db0ef66942e77f09e6372efda&q=" + search,
		"method": "GET",
		"dataType": "json",
	...
	$.ajax(settings).done(function (response) {
		...
		var settings = {
			"async": true,
			"crossDomain": true,
			"url": "https://api.musixmatch.com/ws/1.1/track.lyrics.get?apikey=2d5aab3db0ef66942e77f09e6372efda&track_id=" + musixTrackId,
			"method": "GET",
			"dataType": "json",
			"headers": {
				// "cache-control": "no-cache",
